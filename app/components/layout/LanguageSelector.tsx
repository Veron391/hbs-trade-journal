    ...
    <div className="flex items-center gap-2 mr-3">
      ...
      <div className="relative flex items-center">
        ...
        <select
          ...
          className="appearance-none bg-[#18221A] text-white text-sm rounded-full border border-white/10 pl-9 pr-8 py-2 shadow-inner focus:outline-none focus:ring-2 focus:ring-green-600/40 cursor-pointer"
          style={{
            minWidth: '120px',
            paddingLeft: '36px',
          }}
