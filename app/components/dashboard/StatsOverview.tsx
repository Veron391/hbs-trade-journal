    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div
              ...
              style={{
                boxShadow: filteredStats.totalProfitLoss >= 0
                  ? '0 0 14px 4px rgba(16, 185, 129, 0.18)'
                  : '0 0 14px 4px rgba(239, 68, 68, 0.18)'
              }}
            >
              <DollarSign 
                size={24} 
        ...
        <div className="bg-[#1C1719] rounded-lg shadow p-6 transform-gpu transition-transform duration-200 hover:scale-[1.05]">
          <div className="flex items-center justify-between">
            ...
            <div
              ...
              style={{ boxShadow: '0 0 14px 4px rgba(59, 130, 246, 0.18)' }}
            >
              <Percent 
                size={24} 
        ...
        <div className="bg-[#1C1719] rounded-lg shadow p-6 transform-gpu transition-transform duration-200 hover:scale-[1.05]">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-400 mb-1">Avg. Winning Trade</p>
            ...
            <div
              ...
              style={{ boxShadow: '0 0 14px 4px rgba(16, 185, 129, 0.18)' }}
            >
              <ArrowUpCircle 
                size={24} 
        ...
        <div className="bg-[#1C1719] rounded-lg shadow p-6 transform-gpu transition-transform duration-200 hover:scale-[1.05]">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-400 mb-1">Avg. Losing Trade</p>
            ...
            <div
              ...
              style={{ boxShadow: '0 0 14px 4px rgba(239, 68, 68, 0.18)' }}
            >
              <ArrowDownCircle 
                size={24} 
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-100">
                {filteredStats.averageHoldTime.toFixed(1)} days
              </p>
            </div>
            <div
              className="p-3 rounded-full bg-gray-700"
              style={{ boxShadow: '0 0 14px 4px rgba(156, 163, 175, 0.18)' }}
            >
              <Calendar 
                size={24} 
