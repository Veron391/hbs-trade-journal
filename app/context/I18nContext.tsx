...
const dictionaries: Record<Lang, Dict> = {
  en: {
    ...
    passwordsDoNotMatch: 'Passwords do not match. Please enter the same password.',
  ...
  ru: {
    ...
    passwordsDoNotMatch: 'Пароли не совпадают. Введите тот же пароль.',
  ...
  uz: {
    ...
    phoneNumberRequired: 'Telefon raqami majburiy',
    ...
    passwordsDoNotMatch: 'Parollar mos kelmaydi. Xuddi shu parolni kiriting.',
